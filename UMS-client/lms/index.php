...
<html>
  ...
  <div style="min-height:800px;" class="container1" >
		 <h1 style="text-align:center; padding:50px;"> Welcome <?php //echo $_SESSION["username"];  ?> to the System</h1>
		<!--<p  style="width:50%; margin:auto; "> This is our FF project for the subject of Internet technologies. Main motivation for creating such project is helping teachers to manage subjects and exams easily</p>
