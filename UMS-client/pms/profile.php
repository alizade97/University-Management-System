<?php 
	...
	$sql = "UPDATE user SET fname = '$fname', lname='$lname', country = '$country', city='$city', birth='$birth', sex='$gender', password='$password' WHERE username='$username' AND job='teacher'";
...
<div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <form id="login"  action="profile.php" method="GET">
			  ...
			  $sql2="SELECT * FROM user WHERE username='$user' AND job='teacher'";
...
<table style="margin-top:30px; margin-bottom:50px;" class="table table-striped table-hover table-responsive-sm">
    ...
    <tbody  id="mytable">
		...
		$sql="SELECT *  FROM user WHERE username= '$username' AND job ='teacher' ";
